...
import style from '../css/productTwo.module.css'
...
function ProductTwo() {
    ...
    const [slides] = useState([
        ...
        <Product image={batman} pname="Best of Action Toys" price="Up tp 70% Off"  />,
        <Product image={mic} pname="Microphones" price="Up to 70% Off"  />,
        <Product image={treadmill} pname="Treadmill, Excercise Bikes DT" price="Up to 70% Off"  />,

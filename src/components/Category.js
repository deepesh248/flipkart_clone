        ...
        <ul className={style.ul}>
          ...
          <li className={`${style.dropdown} ${style.categoryList}`}>
            <span className={style.category}>
              ...
              <div>
                Fashion&nbsp;{" "}
                <img className={style.icon} src={arrow} alt="arrow" />
              </div>
            </span>
              ...
              <ul className={style.dropdownUl}>
                <li className={style.dropdownList}>
                  <a className={style.dropdownCat} href="##">
                    ...
                    <ul
                      className={`${style.dropdownUl} ${style.dropdownSubUl}`}
                    >
                      <li className={style.dropdownList}>
                        <a
                          className={` ${style.dropdownCat} ${style.dropdownHeading}`}
                          href="##"
                        >
                    ...
                    >
                      <li className={style.dropdownList}>
                        <a
                          ...
                          href="##"
                        >
                          More in Safety & Hygiene Essentials
                        </a>
                      </li>
                      <li className={style.dropdownList}>
                        <a className={style.dropdownCat} href="##">

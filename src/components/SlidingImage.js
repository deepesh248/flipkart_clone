...
function SlidingImage() {
  return <>
    ...
    <Swiper
        ...
        className="mySwiper"
      >
        <SwiperSlide><a href="##"><img src={first} alt="" /></a></SwiperSlide>
        <SwiperSlide><a href="##"><img src={second} alt="" /></a></SwiperSlide>
        <SwiperSlide><a href="##"><img src={third} alt="" /></a></SwiperSlide>
        <SwiperSlide><a href="##"><img src={fourth} alt="" /></a></SwiperSlide>
      </Swiper>
    </div>
  </>;
}
